...
| `HwachaLaneConfigs.scala` | 复制到 `chipyard/generators/chipyard/src/main/scala/config/` | `HwachaL2RocketConfig`、`HwachaL4RocketConfig`（`WithNLanes(2/4) ++ HwachaRocketConfig`） |
