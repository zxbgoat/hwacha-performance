...
| 2 lane + 2 bank L2 | `rtl-n4096-l2-b2.log` | `micro-n4096-l2-b2.log` | `probe7-l2-b2.log`、`probe8-l2-b2.log`、`tlv-probe7-l2-b2.log.gz`、`tlv-probe8-l2-b2.log.gz`（TileLink 跟踪） |
| 4 lane + 2 bank L2 | `rtl-n4096-l4-b2.log` | `micro-n4096-l4-b2.log` | |
| 4 lane + 4 bank L2 | `rtl-n4096-l4-b4.log` | `micro-n4096-l4-b4.log` | `tlv-probe7-l4-b4.log.gz`（TileLink 跟踪） |
...
| 16 lane（单线程仿真器） | `rtl-n4096-l16.log` | `micro-n4096-l16.log` | `rtl-n4096-l16-threads.log` 是同源码重建的 4 线程仿真器复跑，周期数逐个相同（§10.15） |
