...
| 完整基准平均 / 最大 | 2.5% / 6.9% | 2.4% / 4.7% | 1.8% / 4.8% | 2.5% / 4.8% | __L16_BENCH__ |
...
- 完整基准（8 个内核，数组对齐）：1 lane 平均 2.5%（最大 6.9% sfilter）、2 lane 2.4%（最大 4.7%）、4 lane 1.8%（最大 4.8%）、8 lane 2.5%（最大 4.8%）、16 lane __L16_MEAN__。
